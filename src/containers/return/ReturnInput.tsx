...
import { ReturOffline } from '../../data/AppDatabase';
...
export const ReturnInput: React.FC<any> = (props: any) => {
  ...
  useEffect(() => {
    ...
    // getProduct('8192038881')
    // requestFocusCariBarang()
    // searchRetur("8192038881")
  }, [])
    ...
    getProductCabang(
      ...
      (response: GetProductInventoryResponse) => {
        ...
        if (response.results.length > 0) {
          ...
          console.log("success ",optionProducts);
      ...
      <div>
        ...
        <div className="rainbow-m-around_large">
          <Lookup
            ...
            isLoading={isLoading}
            onChange={(item: any) => {
                console.log('success cart 2',item)
                if (item.value) {
